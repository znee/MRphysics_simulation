...
function runSimulation(forceForwardRecalc = false) {
    ...
    if (ctxChi) drawMap(ctxChi, chiMap, false, 'chi');
    if (ctxField) drawMap(ctxField, fieldMap, true);
    if (ctxRecon) drawMap(ctxRecon, reconMap, false, 'recon');
...
function drawMap(ctx, dataMap, isField, colorbarId = null) {
...
function animate() {
    ...
    if (ctxChi) drawMap(ctxChi, chiMap, false, 'chi');
    if (ctxField) drawMap(ctxField, fieldMap, true);
    if (ctxRecon && window.reconResult) drawMap(ctxRecon, window.reconResult, false, 'recon');
